...
const userService = {
   ...
   * @param {string} id - ID del usuario
   * @param {Object} userData - Datos a actualizar (role, cityId)
   * @returns {Promise<Object>} Usuario actualizado
   */
  async updateUserPermissions(id, userData) {
    ...
    if (userData.cityId !== undefined) {
      // Si cityId es null, permitirlo (admin sin ciudad)
    ...
    // Retornar usuario actualizado con información de ciudad
  ...
  async updateUserAsAdmin(id, userData) {
    ...
    // Retornar usuario actualizado sin la contraseña e incluyendo ciudad
